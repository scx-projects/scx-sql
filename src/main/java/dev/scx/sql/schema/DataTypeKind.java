...
public enum DataTypeKind {
    ...
    private static final Map<Class<?>, DataTypeKind> MAP = initMap();

    private static Map<Class<?>, DataTypeKind> initMap() {
        var map = new HashMap<Class<?>, DataTypeKind>();
        ...
        map.put(BigInteger.class, DECIMAL);
    ...
    public static DataTypeKind ofJavaType(Class<?> javaType) {
