...
public final class DialectSelector {
    ...
    public static Dialect findDialect(DataSource dataSource) {
        ...
        throw new IllegalArgumentException("未找到对应的方言 !!! DataSource: " + dataSource.getClass().getName());
    }

    /// 根据数据库连接 URL 去找 (找不到会报错)
    public static Dialect findDialect(String url) {
        ...
        throw new IllegalArgumentException("未找到对应的方言 !!! URL: " + url);
    }
